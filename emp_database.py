...
def search():
    ...
    if value in emp_dict.keys():
        ...
        label5.config(text='The Employee Id is not present')
        emp_id_detail_entry.delete(0,END)
        emp_name_entry.delete(0,END)
        gender_detail.delete(0,END)
        email_id_entry.delete(0,END)
...
def save():
    ...
    if value3 not in emp_dict.keys():
        emp_dict[value3]=[emp_name_entry.get(),gender_detail.get(),email_id_entry.get(),
                          department_detail.get(),address_detail.get(1.0,END)]
        ...
        label5.config(text='The Employee id is already present in the database')
        emp_id_detail_entry.delete(0,END)
        emp_name_entry.delete(0,END)
        gender_detail.delete(0,END)
        email_id_entry.delete(0,END)
...
def modify():
    ...
    if value1 in emp_dict.keys():
        ...
        label5.config(text='The details have been modified successfully')
...
def delete():
    ...
    if value2 in emp_dict.keys():
        del emp_dict[value2]
        label5.config(text='The Employee record has been deleted successfully')
        emp_id_detail_entry.delete(0,END)
        emp_name_entry.delete(0,END)
        gender_detail.delete(0,END)
        email_id_entry.delete(0,END)
        ...
        label5.config(text='Select the employee id to delete')
        
    else:
        label5.config(text='Employee id is not present in the database')
        emp_id_detail_entry.delete(0,END)
        emp_name_entry.delete(0,END)
        gender_detail.delete(0,END)
        email_id_entry.delete(0,END)
...
heading=Label(win,text='EMPLOYEE DETAILS',font=("Arial Bold",20),fg='dark blue')
...
seperate_line=Label(win,text='_________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________',bg='white',fg='black')
...
address_detail=Text(win,width=30,relief=RAISED,height=5,font=("Arail",15),fg='black')
...
modify_btn=Button(win,text='MODIFY',width=10,font=("Arial",15),command=modify,fg='black',bg='pink')
modify_btn.place(x=550,y=650)

delete_btn=Button(win,text='DELETE',width=10,font=("Arial",15),command=delete,fg='black',bg='pink')
delete_btn.place(x=700,y=650)


clear_btn=Button(win,text='CLEAR',width=10,font=("Arial",15),command=clear,fg='black',bg='pink')
